    ...
    <div className="container mx-auto p-6">
          ...
          <div className="flex">
            <div>
              ...
              <div className="mt-3">
                ...
                >
                  Continue to Admin Dashboard Anyway
                </Button>
              </div>
            </div>
          </div>
      ...
      {session?.user && (
        <div className="bg-green-50 border border-green-200 p-4 rounded-md mb-6">
          <h2 className="text-green-800 font-medium">Authenticated as Admin</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <Card className="hover:shadow-md transition-shadow">
          <CardHeader className="bg-blue-50">
            <CardTitle className="text-blue-700">User Management</CardTitle>
          </CardHeader>
        ...
        <Card className="hover:shadow-md transition-shadow">
          <CardHeader className="bg-purple-50">
            <CardTitle className="text-purple-700">Appointment Overview</CardTitle>
          </CardHeader>
          <CardContent className="pt-4">
        ...
        <Card className="hover:shadow-md transition-shadow">
          <CardHeader className="bg-green-50">
            <CardTitle className="text-green-700">System Settings</CardTitle>
          </CardHeader>
          <CardContent className="pt-4">
